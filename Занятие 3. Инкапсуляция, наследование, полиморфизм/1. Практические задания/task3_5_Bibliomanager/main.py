...
class Book(LibraryItem):
    ...
    def get_info(self):
        return f'Книга: {self.title!r}, Автор: {self.author!r}, Жанр: {self.genre!r}, Год издания: {self.publication_year!r} '
...
class Magazine(LibraryItem):
    ...
    def __init__(self, title, publication_year, issue_number):
        ...
        super().__init__(title,publication_year=publication_year)
    ...
    def get_info(self):
        return f' Журнал: {self.title!r}, Номер выпуска: {self.__issue_number!r}, Год издания: {self.publication_year!r} '
...
class Newspaper(LibraryItem):
    ...
    def get_info(self):
        return f'Газета: {self.title!r}, Дата выпуска: {self.__publication_date!r}, Год издания: {self.publication_year!r}'
